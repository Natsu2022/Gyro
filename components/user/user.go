...
func SendOTPEmail(email, otp string) error {
	...
	emailData := struct {
		...
		Name:    "John Doe",
		Message: "This is a your OTP for verification.",
		OTP:     otp,
	}

	// Read the HTML template from the file
	emailTemplatePath := filepath.Join("./components/user/otp.html")
	emailTemplate, err := ReadHTMLFile(emailTemplatePath)
	if err != nil {
		log.Println("Error reading email template file:", err)
		return err
	}
